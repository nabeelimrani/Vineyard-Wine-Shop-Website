...
<!-- Mirrored from htmlbeans.com/html/vineyard/compare.html by HTTrack Website Copier/3.x [XR&CO'2017], Thu, 24 Aug 2023 05:11:55 GMT -->
<head>
...
<body>
	...
	<div id="wrapper">
		...
		<main id="main">
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 text-center">
							<h2 class="heading text-uppercase fwLight">Compare</h2>
			...
			<!-- compare sec of the page -->
			<div class="compare-sec container">
				<div class="row">
					<div class="col-xs-12 table-responsive">
						<!-- compare table of the page -->
						<table class="table compare-table">
							<tbody>
								<tr>
									<th class="text-center">
										<span class="heading3 text-uppercase">items</span>
									</th>
									<th class="text-center">
										<div class="wrap">
											<div class="img-holder">
												<img src="images/img09.jpg" alt="image description" class="img-responsive">
											</div>
											<strong class="title">Tomatin 12 Year Old</strong>
										</div>
									</th>
									<th class="text-center">
										<div class="wrap">
											<div class="img-holder">
												<img src="images/img10.jpg" alt="image description" class="img-responsive">
											</div>
											<strong class="title">Tomatin 12 Year Old</strong>
										</div>
									</th>
								...
								<tr>
									<td class="text-uppercase text-center">
										<span class="heading3 text-uppercase text-center">rating</span>
									</td>
								...
								<tr class="text-center">
									<td><span class="heading3 text-uppercase">unit price</span></td>
									<td><strong class="heading2 fwBold">$142.00</strong></td>
									<td><strong class="heading2 fwBold">$142.00</strong></td>
									<td><strong class="heading2 fwBold">$142.00</strong></td>
								</tr>
								<tr class="text-center">
									<td class="text-uppercase"><span class="heading3 text-uppercase">description</span></td>
									<td><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p></td>
									<td><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p></td>
									<td><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p></td>
								</tr>
								<tr class="text-center">
									<td>
										<span class="heading3 text-uppercase">manufarure</span>
									</td>
								...
								<tr class="text-center">
									<td><span class="heading3 text-uppercase">availability</span></td>
									<td><span class="txt-green">In Stock</span></td>
									<td><span class="txt-orange">Out Stock</span></td>
									<td><span class="txt-green">In Stock</span></td>
								</tr>
								<tr class="text-center">
									<td><span class="heading3 text-uppercase">size</span></td>
									<td><span class="size lg-round fontcinzel">S</span></td>
									<td><span class="size lg-round fontcinzel">M</span></td>
									<td><span class="size lg-round fontcinzel">L</span></td>
								</tr>
								<tr class="text-center">
									<td><span class="heading3 text-uppercase">size</span></td>
									<td><span class="circle lg-round"></span></td>
									<td><span class="circle blue lg-round"></span></td>
									<td><span class="circle black lg-round"></span></td>
								</tr>
								<tr class="text-center">
									<td><span class="heading3 text-uppercase">quantity</span></td>
									<td><span>01</span></td>
									<td><span>01</span></td>
									<td><span>01</span></td>
								</tr>
								<tr class="text-center">
									<td><span class="heading3 text-uppercase">actions</span></td>
									<td>
										<ul class="list-unstyled social-network">
											<li><a href="wishlist.html" class="lg-round"><i class="fa fa-heart-o"></i></a></li>
											<li><a href="shopping-cart.html" class="lg-round"><i class="fa fa-shopping-cart"></i></a></li>
										</ul>
									</td>
									<td>
										<ul class="list-unstyled social-network">
