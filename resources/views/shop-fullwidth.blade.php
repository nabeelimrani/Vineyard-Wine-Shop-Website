...
<!-- Mirrored from htmlbeans.com/html/vineyard/shop-fullwidth.html by HTTrack Website Copier/3.x [XR&CO'2017], Thu, 24 Aug 2023 05:12:04 GMT -->
<head>
							...
							<div class="col-xs-12 col-sm-4 col-md-3">
								...
								<div class="feature-col">
									<div class="img-holder text-center">
										...
										<span class="p-label text-center text-uppercase">New</span>
									</div>
									<div class="txt-wrap">
										...
										<footer class="footer">
											...
											<strong class="price pull-right">$ 146.00</strong>
										</footer>
									</div>
									<ul class="list-unstyled text-center social-network">
										<li><a href="javascript:void(0);"><i class="fa fa-arrows-alt" aria-hidden="true"></i></a></li>
							...
							<div class="col-xs-12 col-sm-4 col-md-3">
								...
								<div class="feature-col">
									<div class="img-holder text-center">
										...
										<span class="p-label rightside text-center text-uppercase">Sale</span>
									</div>
									<div class="txt-wrap">
										<h2 class="heading3"><a href="shop-detail.html">Tomatin 12 Year Old</a></h2>
										<footer class="footer">
											...
											<strong class="price pull-right">$ 158.00</strong>
										</footer>
									</div>
									<ul class="list-unstyled text-center social-network">
										<li><a href="javascript:void(0);"><i class="fa fa-arrows-alt" aria-hidden="true"></i></a></li>
