...
<!-- Mirrored from htmlbeans.com/html/vineyard/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2017], Thu, 24 Aug 2023 05:11:54 GMT -->
<head>
	...
	<div id="wrapper">
		...
		<main id="main">
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 text-center">
							<h2 class="heading text-uppercase fwLight">My Wishlist</h2>
			...
			<div class="shopping-cart container">
				<div class="row">
					<div class="col-xs-12">
						<p>Product with varients has added to your wishlist. <a href="#">Click here</a> to continue shopping</p>
									...
									<tr>
										...
										<td>
											<div class="content-holder">
												<h3><a href="#">Tomatin 12 Year Old</a></h3>
												<div class="holder">
										...
										<td class="price fwBold">$142.00</td>
										<td>	
											<input type="number" placeholder="1">
										</td>
										<td class="wrap">
											<span class="price pull-left fwBold">$284.00</span>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-4 cart-widget text-center">
						...
						<ul class="list-unstyled cart-totel text-uppercase">
							<li>sub total: <strong class="heading2">$142.00</strong></li>
							<li>grand total: <strong class="heading2">$142.00</strong></li>
						</ul>
						<span class="txt fontjosefin">Checkout with multiple address</span>
						<a href="#" class="btn-primary active text-center text-uppercase lg-round">proceed to checkout</a>
					</div>
				</div>
			</div>
		</main>
...
<!-- Mirrored from htmlbeans.com/html/vineyard/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2017], Thu, 24 Aug 2023 05:11:55 GMT -->
</html>