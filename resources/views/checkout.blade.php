...
<!-- Mirrored from htmlbeans.com/html/vineyard/checkout.html by HTTrack Website Copier/3.x [XR&CO'2017], Thu, 24 Aug 2023 05:11:55 GMT -->
<head>
					...
					<aside class="col-xs-12 col-md-4">
						...
						<div class="cart-widget text-center">
							...
							<ul class="list-unstyled cart-totel">
								...
								<li>Tomatin 12 Year Old x 1<strong class="heading2 pull-right">$142.00</strong></li>
								<li class="bdr-b">Tomatin 12 Year Old x 1<strong class="heading2 pull-right">$142.00</strong></li>
								<li>Cart Subtotal<span class="heading2 pull-right">$142.00</strong></li>
								<li>Shipping and Handling<span class="pull-right">Free Shipping</span></li>
								<li class="bdr-b text-uppercase">Order Total<strong class="heading2 pull-right">$384.00</strong></li>
							</ul>
						</div>
						<!-- Cart Widget of the page -->
						<div class="cart-widget">
							<form action="#" class="currency-form">
								<feildset>
									<label for="radio-6">
										<input id="radio-6" name="group1" type="radio">
										<span class="fake-input"></span>
										<span class="fake-label">Cheque Payment</span>
									</label>
									<label for="radio-7">
										<input id="radio-7" name="group1" type="radio">
										<span class="fake-input"></span>
										<span class="fake-label">PayPal</span>
									</label>
									<button class="btn-primary active text-center text-uppercase lg-round" type="submit">Place Order</button>
								</feildset>
							</form>
						</div>
					</aside>
