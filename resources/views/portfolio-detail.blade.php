...
<!-- Mirrored from htmlbeans.com/html/vineyard/portfolio-detail.html by HTTrack Website Copier/3.x [XR&CO'2017], Thu, 24 Aug 2023 05:12:23 GMT -->
<head>
...
<body>
	...
	<div id="wrapper">
		...
		<main id="main">
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 text-center">
							<h2 class="heading text-uppercase fwLight">Portfolio details</h2>
			...
			<!-- portfolio detail of the page -->
			<div class="portfolio-detail container">
				<div class="row">
					<div class="col-xs-12 col-sm-8">
						<!-- portfolio slider of the page -->
						<div class="portfolio-slider">
							<div class="slide">
								<img src="images/img115.jpg" class="img-responsive" alt="image-description">
							</div>
							<div class="slide">
								<img src="images/img116.jpg" class="img-responsive" alt="image-description">
							</div>
							<div class="slide">
								<img src="images/img116.jpg" class="img-responsive" alt="image-description">
							</div>
						...
						<ul class="list-unstyled slick-slider pagg-slider">
							<li><img src="images/img117.jpg" alt="image description" class="img-responsive"></li>
							<li><img src="images/img118.jpg" alt="image description" class="img-responsive"></li>
							<li><img src="images/img119.jpg" alt="image description" class="img-responsive"></li>
							<li><img src="images/img120.jpg" alt="image description" class="img-responsive"></li>
						</ul>
					</div>
					<div class="col-xs-12 col-sm-4 col-lg-3 col-lg-offset-1">
						<!-- holder of the page -->
						<div class="holder">
							<h3 class="heading5">Neyers Vineyards</h3>
							...
							<ul class="list-unstyled client-details">
								<li>Client: <strong class="text-uppercase">DANIEL CRAWLER</strong></li>
								<li>Date: <time datetime="2018-03-02 20:00"><strong>09-08-2015</strong></time></li>
								<li>Location: <strong class="text-capitalize">United States</strong></li>
								<li>Author: <strong>Leonard</strong></li>
								<li class="text-center"><a href="javascript:void(0);" class="fontbase text-uppercase btn-primary lg-round">view project</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row mar-bt">
						<div class="col-xs-12 col-sm-6 col-md-4">
							<div class="logo">
								<a href="javascript:void(0);"><img class="img-responsive" src="images/logo.png" alt="vineyard"></a>
							</div>
...
<!-- Mirrored from htmlbeans.com/html/vineyard/portfolio-detail.html by HTTrack Website Copier/3.x [XR&CO'2017], Thu, 24 Aug 2023 05:12:31 GMT -->
</html>