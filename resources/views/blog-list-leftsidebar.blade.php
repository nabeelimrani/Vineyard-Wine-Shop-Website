...
<!-- Mirrored from htmlbeans.com/html/vineyard/blog-list-leftsidebar.html by HTTrack Website Copier/3.x [XR&CO'2017], Thu, 24 Aug 2023 05:12:37 GMT -->
<head>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 text-center">
							<h2 class="heading text-uppercase fwLight">Left Sidebar</h2>
			...
			<section class="blog-sec container">
				<div class="row">
					...
					<article id="content" class="col-xs-12 col-md-9 pull-right">
						...
						<div class="col-xs-12 blog-col style5">
							<div class="img-holder">
								<a href="blog-detail-fullwidth.html"><img src="images/img76.jpg" alt="image description" class="img-responsive"></a>
							</div>
							<div class="txt-holder">
								<time class="time text-uppercase" datetime="2018-03-02 20:00">AUG <span class="day">08</span></time>
								<h3 class="heading4 fwNormal"><a href="blog-detail-fullwidth.html">Fieldsheer Motorcycle Products</a></h3>
						...
						<div class="col-xs-12 blog-col style5">
							<div class="img-holder">
								<a href="blog-detail-fullwidth.html"><img src="images/img77.jpg" alt="image description" class="img-responsive"></a>
							</div>
							<div class="txt-holder">
								<time class="time text-uppercase" datetime="2018-03-02 20:00">Jun <span class="day">24</span></time>
								<h3 class="heading4 fwNormal"><a href="blog-detail-fullwidth.html">William Shatner's New Wine Enterprise</a></h3>
								<p>Excepteur sint occaecat cupidatat non proident, sunt in culpa  officia deserunt mollitid est laborum. Sed ut perspiciatis unde qui omnis iste natus error sit voluptatem.</p>
								<a href="blog-detail-fullwidth.html" class="read-more text-uppercase">CONTINUE <i class="fa fa-long-arrow-right"></i></a>
							</div>
						</div>
						...
						<div class="col-xs-12 blog-col style5">
							<div class="img-holder">
								<a href="blog-detail-fullwidth.html"><img src="images/img78.jpg" alt="image description" class="img-responsive"></a>
							</div>
							<div class="txt-holder">
								<time class="time text-uppercase" datetime="2018-03-02 20:00">Dec <span class="day">12</span></time>
								<h3 class="heading4 fwNormal"><a href="blog-detail-fullwidth.html">Recipes from a Winemaker's Restaurant</a></h3>
								<p>Excepteur sint occaecat cupidatat non proident, sunt in culpa  officia deserunt mollitid est laborum. Sed ut perspiciatis unde qui omnis iste natus error sit voluptatem.</p>
								<a href="blog-detail-fullwidth.html" class="read-more text-uppercase">CONTINUE <i class="fa fa-long-arrow-right"></i></a>
							</div>
						</div>
						...
						<div class="col-xs-12 blog-col style5">
							<div class="img-holder">
								<a href="blog-detail-fullwidth.html"><img src="images/img79.jpg" alt="image description" class="img-responsive"></a>
							</div>
							<div class="txt-holder">
								<time class="time text-uppercase" datetime="2018-03-02 20:00">July <span class="day">06</span></time>
								<h3 class="heading4 fwNormal"><a href="blog-detail-fullwidth.html">Louis Jadot Fine &amp; Wine Tasting</a></h3>
								<p>Excepteur sint occaecat cupidatat non proident, sunt in culpa  officia deserunt mollitid est laborum. Sed ut perspiciatis unde qui omnis iste natus error sit voluptatem.</p>
								<a href="blog-detail-fullwidth.html" class="read-more text-uppercase">CONTINUE <i class="fa fa-long-arrow-right"></i></a>
							</div>
						</div>
					...
					<aside id="sidebar" class="col-xs-12 col-md-3 pull-left">
						...
						<section class="widget">
							<div class="img-holder">
								<img src="images/img70.jpg" alt="image-description" class="img-responsive">
							</div>
						</section>
						<!-- widget of the page -->
						<section class="widget">
							...
							<ul class="list-unstyled feature-list feature2">
								<li>
									<div class="img-holder text-center pull-left">
										<img src="images/img80.jpg" class="img-responsive" alt="img-description">
									</div>
									<div class="txt-holder pull-left">
										<h3 class="heading3"><a href="blog-detail-fullwidth.html">Tomatin 12 Year Old</a></h3>
										<time class="time" datetime="2018-11-23">MAR 8, 2018</time>
									</div>
								</li>
								<li>
									<div class="img-holder text-center pull-left">
										<img src="images/img81.jpg" class="img-responsive" alt="img-description">
									</div>
									<div class="txt-holder pull-left">
										<h3 class="heading3"><a href="blog-detail-fullwidth.html">Tomatin 12 Year Old</a></h3>
										<time class="time" datetime="2018-11-23">MAR 8, 2018</time>
								...
								<li>
									<div class="img-holder text-center pull-left">
										<img src="images/img82.jpg" class="img-responsive" alt="img-description">
									</div>
									<div class="txt-holder pull-left">
										<h3 class="heading3"><a href="blog-detail-fullwidth.html">Tomatin 12 Year Old</a></h3>
										<time class="time" datetime="2018-11-23">MAR 8, 2018</time>
								...
								<li>
									<div class="img-holder text-center pull-left">
										<img src="images/img83.jpg" class="img-responsive" alt="img-description">
									</div>
									<div class="txt-holder pull-left">
										<h3 class="heading3"><a href="blog-detail-fullwidth.html">Tomatin 12 Year Old</a></h3>
										<time class="time" datetime="2018-11-23">MAR 8, 2018</time>
								...
								<li>
									<div class="img-holder text-center pull-left">
										<img src="images/img84.jpg" class="img-responsive" alt="img-description">
									</div>
									<div class="txt-holder pull-left">
										<h3 class="heading3"><a href="blog-detail-fullwidth.html">Tomatin 12 Year Old</a></h3>
										<time class="time" datetime="2018-11-23">MAR 8, 2018</time>
				...
				<div class="container">
					<div class="row mar-bt">
						<div class="col-xs-12 col-sm-6 col-md-4">
							<div class="logo">
								<img class="img-responsive" src="images/logo.png" alt="vineyard" >
							</div>
...
<!-- Mirrored from htmlbeans.com/html/vineyard/blog-list-leftsidebar.html by HTTrack Website Copier/3.x [XR&CO'2017], Thu, 24 Aug 2023 05:12:42 GMT -->
</html>