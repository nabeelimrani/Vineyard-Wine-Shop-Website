...
<!-- Mirrored from htmlbeans.com/html/vineyard/shop-detail.html by HTTrack Website Copier/3.x [XR&CO'2017], Thu, 24 Aug 2023 05:12:04 GMT -->
<head>
					...
					<div class="col-xs-12">
						<div class="slider">
							...
							<div class="product-slider">
								<div class="slide">
									<img src="images/img71.jpg" class="img-responsive" alt="image description">
								</div>
								<div class="slide">
									<img src="images/img71.jpg" class="img-responsive" alt="image description">
								</div>
							...
							<ul class="list-unstyled slick-slider pagg-slider">
								<li><img src="images/img72.jpg" alt="image description" class="img-responsive"></li>
								<li><img src="images/img73.jpg" alt="image description" class="img-responsive"></li>
								<li><img src="images/img74.jpg" alt="image description" class="img-responsive"></li>
							</ul>
						</div>
						<h2 class="heading5">OneHope Best of California II Wine</h2>
						...
						<strong class="price fontbase">$146.00</strong>
						<p>A generous helping of cocoa, vanilla, over-ripe plum, and raspberry. Long on the mid palate with subtle tannins makes this very easy to drink. A deliciously rich merlot only Washington fruit can produce. 88 points by wine enthusiasists.</p>
						<!-- footer of the page -->
						<footer class="footer">
							<div class="f-holder">
			...
			<div class="feature-sec container">
				<div class="row">
					...
					<header class="col-xs-12 text-center header">
						...
						<h1 class="heading text-uppercase">related products</h1>
				...
				<div class="row">
					...
					<div class="col-xs-12 text-center">
						<a href="shop-detail.html" class="btn-primary lg-round text-uppercase">View All</a>
					</div>
				</div>
			</div>
		</main>
...
<!-- Mirrored from htmlbeans.com/html/vineyard/shop-detail.html by HTTrack Website Copier/3.x [XR&CO'2017], Thu, 24 Aug 2023 05:12:09 GMT -->
</html>