...
<!-- Mirrored from htmlbeans.com/html/vineyard/portfolio3.html by HTTrack Website Copier/3.x [XR&CO'2017], Thu, 24 Aug 2023 05:12:12 GMT -->
<head>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 text-center">
							<h2 class="heading text-uppercase fwLight">3 collumns style1</h2>
			...
			<div class="portfolio-sec container">
				<div class="row">
					<div class="col-xs-12">
						...
						<ul class="list-unstyled filter-list text-center">
							...
							<li><a href="javascript:void(0);" data-filter=".animation">Animation</a></li>
				...
				<div class="row">
					...
					<div id="feature-holder">
						...
						<div class="col-xs-12 col-sm-6 col-md-4 item-col branding">
							<!-- portfolio col of the page -->
							<div class="portfolio-col">
								<figure class="img-holder">
									<img src="images/img99.jpg" alt="image description" class="img-responsive">
								</figure>
								<div class="wrap">
									<div class="content pull-left">
										<h3 class="heading2"><a href="portfolio-detail.html">Amber Bottle</a></h3>
										<p><i>Branding Identity</i></p>
									</div>
									<ul class="list-unstyled text-center social-network pull-right">
										<li><a href="javascript:void(0);" class="lg-round text-center"><i class="fa fa-arrows-alt"></i></a></li>
										<li><a href="javascript:void(0);" class="lg-round text-center"><i class="fa fa-paperclip"></i></a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-4 item-col web">
							<!-- portfolio col of the page -->
							<div class="portfolio-col">
								<figure class="img-holder">
									<img src="images/img100.jpg" alt="image description" class="img-responsive">
								</figure>
								<div class="wrap">
									<div class="content pull-left">
										<h3 class="heading2"><a href="portfolio-detail.html">Amber Bottle</a></h3>
						...
						<div class="col-xs-12 col-sm-6 col-md-4 item-col animation">
							<!-- portfolio col of the page -->
							<div class="portfolio-col">
								<figure class="img-holder">
									<img src="images/img101.jpg" alt="image description" class="img-responsive">
								</figure>
								<div class="wrap">
									<div class="content pull-left">
										<h3 class="heading2"><a href="portfolio-detail.html">Amber Bottle</a></h3>
						...
						<div class="col-xs-12 col-sm-6 col-md-4 item-col app">
							<!-- portfolio col of the page -->
							<div class="portfolio-col">
								<figure class="img-holder">
									<img src="images/img102.jpg" alt="image description" class="img-responsive">
								</figure>
								<div class="wrap">
									<div class="content pull-left">
										<h3 class="heading2"><a href="portfolio-detail.html">Amber Bottle</a></h3>
						...
						<div class="col-xs-12 col-sm-6 col-md-4 item-col branding">
							...
							<div class="portfolio-col">
								<figure class="img-holder">
									<img src="images/img103.jpg" alt="image description" class="img-responsive">
								</figure>
								<div class="wrap">
									<div class="content pull-left">
										<h3 class="heading2"><a href="portfolio-detail.html">Amber Bottle</a></h3>
						...
						<div class="col-xs-12 col-sm-6 col-md-4 item-col web">
							...
							<div class="portfolio-col">
								<figure class="img-holder">
									<img src="images/img104.jpg" alt="image description" class="img-responsive">
								</figure>
								<div class="wrap">
									<div class="content pull-left">
										<h3 class="heading2"><a href="portfolio-detail.html">Amber Bottle</a></h3>
						...
						<div class="col-xs-12 col-sm-6 col-md-4 item-col animation">
							...
							<div class="portfolio-col">
								<figure class="img-holder">
									<img src="images/img105.jpg" alt="image description" class="img-responsive">
								</figure>
								<div class="wrap">
									<div class="content pull-left">
										<h3 class="heading2"><a href="portfolio-detail.html">Amber Bottle</a></h3>
						...
						<div class="col-xs-12 col-sm-6 col-md-4 item-col app">
							...
							<div class="portfolio-col">
								<figure class="img-holder">
									<img src="images/img106.jpg" alt="image description" class="img-responsive">
								</figure>
								<div class="wrap">
									<div class="content pull-left">
										<h3 class="heading2"><a href="portfolio-detail.html">Amber Bottle</a></h3>
						...
						<div class="col-xs-12 col-sm-6 col-md-4 item-col app">
							...
							<div class="portfolio-col">
								<figure class="img-holder">
									<img src="images/img107.jpg" alt="image description" class="img-responsive">
								</figure>
								<div class="wrap">
									<div class="content pull-left">
										<h3 class="heading2"><a href="portfolio-detail.html">Amber Bottle</a></h3>
					...
					<div class="col-xs-12 text-center">
						<a href="javascript:void(0);" class="btn-primary lg-round text-uppercase">View All</a>
					</div>
				</div>
			</div>
		</main>
...
<!-- Mirrored from htmlbeans.com/html/vineyard/portfolio3.html by HTTrack Website Copier/3.x [XR&CO'2017], Thu, 24 Aug 2023 05:12:23 GMT -->
</html>