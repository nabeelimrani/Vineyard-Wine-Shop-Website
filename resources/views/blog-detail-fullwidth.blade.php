...
<!-- Mirrored from htmlbeans.com/html/vineyard/blog-detail-fullwidth.html by HTTrack Website Copier/3.x [XR&CO'2017], Thu, 24 Aug 2023 05:12:42 GMT -->
<head>
				...
				<div class="row">
					<div class="col-xs-12">
						<figure class="img-holder">
							<img src="images/img89.jpg" class="img-responsive" alt="Image Description">
						</figure>
						...
						<div class="blog-holder">
							...
							<header class="header">
								...
								<div class="wrap">
									<h3 class="heading6">William Shatner's New Wine Enterprise</h3>
							...
							<!-- blockquote of the page -->
							<blockquote class="blockquote">
								<q>Creativity is just connecting things. When you ask creative people how they did something, they feel a little guilty because they didn't really do it, they just saw something. </q>
								<cite class="text-uppercase">LUCY MARKET <i class="fa fa-quote-left pull-right"></i></cite>
							</blockquote>
							<h3 class="heading4">Recipes from a Winemaker's Restaurant</h3>
							...
							<div class="comments-block">
								<h4 class="heading2 text-uppercase">2 Comments</h4>
								<article class="commment-area">
									<a href="javascript:void(0);" class="img"><img src="images/img86.jpg" alt="image description" class="img-responsive"></a>
									<div class="txt-holder">
										<div class="header">
											<span class="comment-date">
												<time datetime="2018-01-01">MAR 8, 2018</time>
												<h3 class="heading3"><a href="javascript:void(0);">TuanClean</a></h3>
											</span>
											<a href="javascript:void(0);" class="btn-primary lg-round text-uppercase">reply</a>
										</div>
								...
								<div class="commment-onelevel">
									<article class="commment-area">
										<a href="javascript:void(0);" class="img"><img src="images/img87.jpg" alt="image description" class="img-responsive"></a>
										<div class="txt-holder">
											<div class="header">
												<span class="comment-date">
													<time datetime="2018-01-01">MAR 8, 2018</time>
													<h3 class="heading3"><a href="javascript:void(0);">LeoNard</a></h3>
												</span>
												<a href="javascript:void(0);" class="btn-primary lg-round text-uppercase">reply</a>
											</div>
											<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam.</p>
								...
								<article class="commment-area">
									<a href="javascript:void(0);" class="img"><img src="images/img88.jpg" alt="image description" class="img-responsive"></a>
									<div class="txt-holder">
										<div class="header">
											<span class="comment-date">
												<time datetime="2018-01-01">MAR 8, 2018</time>
							...
							<!-- comments-formarea of the page -->
							<div class="comment-formarea">
								<h2 class="heading2 text-uppercase">LeaVe A Comment</h2>
								<div class="row">
									<form class="commentform">
										...
										<button type="submit" class="btn-primary active lg-round text-center text-uppercase">SEND MESSAGES</button>
									</form>
								</div>
							</div>
						</div>
...
<!-- Mirrored from htmlbeans.com/html/vineyard/blog-detail-fullwidth.html by HTTrack Website Copier/3.x [XR&CO'2017], Thu, 24 Aug 2023 05:12:47 GMT -->
</html>